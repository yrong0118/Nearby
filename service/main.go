...
const (
	...
	POST_TYPE   = "post"
	DISTANCE    = "200km"
	ES_URL      = "http://35.202.47.99:9200"
	BUCKET_NAME = "bucket_ry"

	//**************************
	ENABLE_BIGTABKE = true
	//**************************
	API_PREFIX = "/api/v1"
)
...
// 	bt_client, err := bigtable.NewClient(ctx, "calm-photon-225722", "around-post", option.WithCredentialsFile("/Users/yue/Documents/Around/service/Around-752f7fe9f70e.json"))
// 	if err != nil {
// 		panic(err)
// 		return
// 	}
...
func saveToGCS(r io.Reader, bucketName, objectName string) (*storage.ObjectAttrs, error) {
	...
	// Creates a client.
	client, err := storage.NewClient(ctx, option.WithCredentialsFile("/Users/yue/Documents/Around/service/Around-752f7fe9f70e.json"))
